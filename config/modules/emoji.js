...
msg(TARGET,emojify("Where is (bear)?"));

Functions:

emojify(INPUT_TEXT)
  Inserts ASCIImojis into text.

asciimoji(TEXT,OPTIONS,USERDICTIONARY)
  The complete asciiemoji function as provided by the author.
  See http://asciimoji.com for more information.

*/  

function emojify(INPUT_TEXT){
  return asciimoji(INPUT_TEXT);
}
